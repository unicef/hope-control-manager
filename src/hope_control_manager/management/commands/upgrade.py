...
import hope_control_manager
from hope_control_manager.config import env
...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> None:  # noqa: C901
        from hope_control_manager.models import User  # noqa: PLC0415
        ...
        try:
            ...
            echo(f"Running upgrade of version {hope_control_manager.VERSION}", style_func=self.style.WARNING)
