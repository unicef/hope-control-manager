...
PACKAGE_DIR = Path(__file__).parent.parent  # hope_control_manager/
SOURCE_DIR = PACKAGE_DIR.parent  # src/
PROJECT_DIR = SOURCE_DIR.parent
ALLOWED_HOSTS = ["*"]
INSTALLED_APPS = [
    # Default apps:
    "hope_control_manager.apps.Config",
    "hope_control_manager.api",
    "hope_control_manager.ui.theme",
    "hope_control_manager.ui",
    "hope_control_manager.modules.security",
...
AUTH_USER_MODEL = "hope_control_manager.user"
...
SESSION_COOKIE_NAME = "hope_control_manager_id"
...
EMAIL_SUBJECT_PREFIX = "[HOPE Control Manager]"
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="psql://postgres:@127.0.0.1:5432/hope_control_manager"),
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "hope_control_manager.ui.context_processors.app",
            ],
        },
    },
]
...
# URL Configuration
# ------------------------------------------------------------------------------
ROOT_URLCONF = "hope_control_manager.config.urls"
...
WSGI_APPLICATION = "hope_control_manager.config.wsgi.application"
...
KEY_FUNCTION = "hope_control_manager.utils.cache.make_key"
