...
DEFAULTS = {
    ...
    "CSRF_COOKIE_NAME": (str, "hope_control_manager"),
    "CSRF_COOKIE_SECURE": (bool, True, False),
    "CSRF_TRUSTED_ORIGINS": (list, [], []),
    "DATABASE_URL": (str, "psql://postgres:@127.0.0.1:5432/hope_control_manager"),
    "DEBUG": (bool, False),
    ...
    "MEDIA_ROOT": (str, os.path.join(tempfile.gettempdir(), "hope_control_manager", "media")),
    ...
    "STATIC_ROOT": (str, os.path.join(tempfile.gettempdir(), "hope_control_manager", "static")),
