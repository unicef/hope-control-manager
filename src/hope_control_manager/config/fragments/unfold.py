...
UNFOLD = {
    ...
    "ENVIRONMENT": "hope_control_manager.config.fragments.unfold.environment_callback",  # environment name in header
    "SHOW_HISTORY": True,
    "SITE_TITLE": "HOPE Control Manager: ",
    "SITE_HEADER": "HOPE Control Manager",
    "SITE_SUBHEADER": "",
    "SITE_FAVICONS": [
        {
            "rel": "icon",
                ...
                "items": [
                    {
                        "title": _("Users"),
                        "icon": "person",
                        "link": reverse_lazy("admin:hope_control_manager_user_changelist"),
                    },
                    {
                        "title": _("Groups"),
                        "icon": "people",
